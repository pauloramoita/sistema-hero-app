document.addEventListener('DOMContentLoaded', () => {
    ...
    let state = {
        ...
        praiaCaixa: JSON.parse(localStorage.getItem('praiaCaixa')) || [],
        praiaVendas: JSON.parse(localStorage.getItem('praiaVendas')) || [],
        praiaCompras: JSON.parse(localStorage.getItem('praiaCompras')) || [],
        selectedPedidos: [],
    };
        ...
        handleSubTab: (tabId) => {
            switch (tabId) {
                ...
                case 'financeiro-container':
                    ...
                    break;
                case 'praia-container':
                    tabManager.switchSubTab('praia-caixa', 'praia-container');
                    break;
